...
## Purpose
Capturing a mark or a note against a book: the mark control on the Player and in the Reader, the lead-in anchor, the chapter-title snapshot, what an entry stores, and what becomes of a book's entries when the book is removed.
