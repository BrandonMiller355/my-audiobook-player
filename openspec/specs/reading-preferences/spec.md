...
How the reader draws text, and how bright the screen is while it does: text size, line spacing,
typeface, and reading brightness.

All four are app-wide rather than per book — they describe the reader and the room it is read in,
not any particular book. Only the reading *position* is per book, and that belongs to
[[ebook-reader]].
