...
## Purpose
TBD - created by archiving change add-transport-controls. Update Purpose after archive.
## Requirements
...
The user SHALL be able to select a playback speed from the set defined in PRD Â§9 (0.75x through
...
that position â€” without starting playback â€” the next time the book is opened. Saving SHALL NOT
